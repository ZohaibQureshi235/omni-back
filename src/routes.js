...
import { PostImage, GetImage, updateImageViews, updatedImageLike, updateImagedowload, searchImage, getSectionImage, fetchCat, getAllImages } from '../controller/ImageController.js'

...
import { PostImage, GetImage, updateImageViews, updateImage, updatedImageLike, updateImagedowload, searchImage, getSectionImage, fetchCat, getAllImages, deleteImage } from '../controller/ImageController.js'
